# ES6
JavaScript has been standardized as ECMAScript, or ES. This specification is used by all major browsers, hence JavaScript and ECMAScript can be used interchangeably.

Up until now, the majority of the JavaScript you have learnt has been in ES5 (ECMAScript 5), which was released in 2009. Even though ES5 programs can still be written, JavaScript is always changing and gaining new features every year.

2015 saw the release of ES6, which gave the language numerous significant new capabilities. These new features—arrow functions, destructuring, classes, promises, and modules—will be covered in this course.
...
his code will still return the string `value` by default.
